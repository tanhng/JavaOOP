...
//		Date today=new Date();
	...
	public int utils(MyDate date1) {
		if (this.getDay()!=date1.getDay()) return 0;
		else if (this.getMonth()!=date1.getMonth()) return 0;
		else if (this.getYear()!=date1.getYear()) return 0;
		return 1;
	}
